...
import pysparkIcon from "../img/pyspark.png";
import "./Skills.css"
    ...
    return (
        <div class="interests  bg-dark">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 mt-4">
                    <div class="icon-box">
                        <i class="fa fa-database" aria-hidden="true"></i> {/* Reusing for SQL */}
                        <h3>SQL</h3>
                    </div>
                </div>
                ...
                <div className="col-lg-3 col-md-4 mt-4">
                    <div className="icon-box">
                        <i className="fab fa-aws" style={{ fontSize: 30, color: "#FF9900" }}></i>
                        <h3>AWS</h3>
                    </div>
                </div>
